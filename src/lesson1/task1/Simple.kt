 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = deg * 0.0174533 + min * 0.000290888 + sec * 0.0000048481
 ...
 */
fun thirdDigit(number: Int): Int = number % 1000
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val hoursTrack = hoursArrive - hoursDepart
    val minutesTrack = minutesArrive - minutesDepart
    val timeTrack = hoursTrack * 60 + minutesTrack
    return timeTrack
}
